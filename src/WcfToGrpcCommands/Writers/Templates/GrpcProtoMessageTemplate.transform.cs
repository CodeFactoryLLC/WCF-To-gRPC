...
{
    public partial class GrpcProtoMessageTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcProtoMessageTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcProtoMessageTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcProtoMessageTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcProtoMessageTemplate { CsModels = null, ModelData = modelData };
