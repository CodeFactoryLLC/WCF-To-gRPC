...
{
    public partial class GrpcProtoServiceTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcProtoServiceTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcProtoServiceTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcProtoServiceTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcProtoServiceTemplate { CsModels = null, ModelData = modelData };
