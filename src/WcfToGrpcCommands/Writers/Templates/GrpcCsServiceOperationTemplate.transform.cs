...
namespace WcfToGrpcCommands.Writers.Templates
{
    public partial class GrpcCsServiceOperationTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcCsServiceOperationTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcCsServiceOperationTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcCsServiceOperationTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcCsServiceOperationTemplate { CsModels = null, ModelData = modelData };
