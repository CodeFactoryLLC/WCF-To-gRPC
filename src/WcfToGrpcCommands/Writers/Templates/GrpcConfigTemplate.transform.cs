...
{
    public partial class GrpcConfigTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcConfigTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcConfigTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcConfigTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcConfigTemplate { CsModels = null, ModelData = modelData };
