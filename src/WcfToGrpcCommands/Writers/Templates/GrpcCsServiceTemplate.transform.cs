...
{
    public partial class GrpcCsServiceTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcCsServiceTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcCsServiceTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcCsServiceTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcCsServiceTemplate { CsModels = null, ModelData = modelData };
