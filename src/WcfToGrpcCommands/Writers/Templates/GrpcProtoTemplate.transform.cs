...
{
    public partial class GrpcProtoTemplate : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new GrpcProtoTemplate { CsModels = null, ModelData = null };
        ...
        {
            var factory = new GrpcProtoTemplate { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new GrpcProtoTemplate { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new GrpcProtoTemplate { CsModels = null, ModelData = modelData };
